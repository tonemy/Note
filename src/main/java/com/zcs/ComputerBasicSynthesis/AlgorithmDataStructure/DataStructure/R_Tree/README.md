...
1) R-Tree的一篇被我标注过的论文: [下载地址](https://github.com/tonemy/MyAlgorithm/raw/master/src/main/java/com/zcs/ComputerBasicSynthesis/AlgorithmDataStructure/DataStructure/R_Tree/p47-guttman.pdf),网上的大多关于R-Tree的介绍和我写的这个都来源于这篇优秀的
 IEEE论文.
